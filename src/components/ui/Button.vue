...
.ui-button {
    @apply px-5 transition-colors border overflow-hidden relative py-3 rounded-xx w-fit disabled:cursor-not-allowed;
    &.primary {
        ...
        &:disabled {
            ...
            &.is-loading {
                @apply bg-secondary-yellow border-secondary-yellow;
            }
        }
